...
MEALS: list[dict[str, Any]] = [
    ...
    {
        "name": "Egg quinoa breakfast skillet",
        "description": "Eggs, cottage cheese, quinoa, spinach and tomatoes in a savory skillet",
        "ingredients": [
            ingredient("Eggs", "4"),
            ingredient("Cottage cheese", "200 g"),
            ingredient("Quinoa", "160 g cooked"),
            ingredient("Spinach", "100 g"),
            ingredient("Tomatoes", "180 g"),
        ],
        "hands": 12,
        ...
        "produce": 2.5,
        "effort": 2,
        "tags": ["egg", "fast", "high-protein"],
    },
    {
        "name": "Salmon skyr potato bowl",
        "description": "Salmon and potatoes with spinach, tomatoes and a cool skyr sauce",
        "ingredients": [
            ingredient("Salmon", "220 g"),
            ingredient("Potatoes", "300 g"),
            ingredient("Skyr / quark", "150 g"),
            ingredient("Spinach", "100 g"),
            ingredient("Tomatoes", "180 g"),
        ],
        "hands": 12,
    ...
    {
        "name": "Chicken lentil skillet",
        "description": "Chicken and lentils simmered with tomatoes and mixed vegetables",
        "ingredients": [
            ingredient("Chicken breast", "220 g"),
            ingredient("Lentils", "220 g cooked"),
            ingredient("Frozen mixed vegetables", "250 g"),
            ingredient("Tomatoes", "180 g"),
        ],
        "hands": 15,
        ...
        "produce": 3,
        "effort": 2,
        "tags": ["batch", "freezer", "high-protein", "high-fiber"],
    },
    {
        "name": "Cottage cheese chickpea crunch bowl",
        "description": "Cottage cheese and chickpeas with crisp vegetables and wholegrain toast",
        "ingredients": [
            ingredient("Cottage cheese", "300 g"),
            ingredient("Chickpeas", "180 g cooked"),
            ingredient("Tomatoes", "180 g"),
            ingredient("Peppers", "120 g"),
            ingredient("Spinach", "80 g"),
            ingredient("Wholegrain bread", "100 g"),
        ],
        "hands": 8,
        "total": 8,
        "batch": 1,
        ...
        "produce": 3,
        "effort": 1,
        "tags": ["no-cook", "fast", "high-fiber"],
    },
    {
        "name": "High-protein shakshuka",
        "description": "Baked eggs, chickpeas and cottage cheese in a rich pepper-tomato base",
        "ingredients": [
            ingredient("Eggs", "4"),
            ingredient("Cottage cheese", "200 g"),
            ingredient("Chickpeas", "160 g cooked"),
            ingredient("Tomatoes", "300 g"),
            ingredient("Peppers", "180 g"),
            ingredient("Spinach", "100 g"),
            ingredient("Wholegrain bread", "100 g"),
        ],
        "hands": 25,
        ...
        "fridge": 2,
        "freeze": False,
        "reheat": "Warm the tomato base, then cook fresh eggs in it",
        "protein": 65,
        "fiber": 20,
        "produce": 4,
        "effort": 4,
        "tags": ["special", "egg", "high-protein", "high-fiber"],
    },
    {
        "name": "Mediterranean stuffed peppers",
        "description": "Roasted peppers filled with chicken, quinoa, spinach and cottage cheese",
        "ingredients": [
            ingredient("Chicken breast", "220 g"),
            ingredient("Quinoa", "180 g cooked"),
            ingredient("Peppers", "300 g"),
            ingredient("Spinach", "100 g"),
            ingredient("Tomatoes", "180 g"),
        ...
        "fridge": 3,
        "freeze": True,
        "reheat": "Bake at 180 C for 15 minutes",
        "protein": 78,
        "fiber": 14,
        "produce": 4,
        "effort": 4,
        "tags": ["special", "high-protein", "batch", "freezer"],
    },
    {
        "name": "Herbed salmon quinoa feast",
        "description": "Roasted salmon over quinoa with broccoli, spinach, peppers and tomatoes",
        "ingredients": [
            ingredient("Salmon", "240 g"),
            ingredient("Quinoa", "200 g cooked"),
            ingredient("Broccoli", "200 g"),
            ingredient("Spinach", "100 g"),
            ingredient("Peppers", "120 g"),
        ...
        "fridge": 2,
        "freeze": False,
        "reheat": "Warm gently in the oven",
        "protein": 60,
        "fiber": 15,
        "produce": 4.5,
        "effort": 4,
        "tags": ["special", "fish", "high-protein"],
    },
    {
        "name": "Chicken lentil cottage pie",
        "description": "Savory chicken, lentils and vegetables beneath a cottage-cheese potato top",
        "ingredients": [
            ingredient("Chicken breast", "220 g"),
            ingredient("Lentils", "200 g cooked"),
            ingredient("Potatoes", "320 g"),
            ingredient("Frozen mixed vegetables", "250 g"),
            ingredient("Tomatoes", "180 g"),
            ingredient("Cottage cheese", "180 g"),
        ],
        "hands": 30,
        "total": 55,
        "batch": 4,
        "fridge": 3,
        "freeze": True,
        "reheat": "Bake at 180 C for 20 minutes",
        "protein": 82,
        "fiber": 22,
        "produce": 3.5,
        "effort": 4,
        "tags": ["special", "high-protein", "high-fiber", "batch", "freezer"],
    },
    {
